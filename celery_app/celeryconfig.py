...
broker_transport_options = {
    'visibility_timeout': 3600,  # 1小时 - 降低任务可见性超时，避免任务卡住太久
    'socket_timeout': 60,         # socket超时 - 60秒
    'socket_connect_timeout': 10,  # 连接超时 - 10秒
    'socket_keepalive': True,    # 保持连接
    'max_connections': 20,       # 最大连接数 - 20
...
redis_backend_socket_connect_timeout = 10  # 连接超时 - 10秒
redis_backend_socket_timeout = 60         # socket超时 - 60秒
...
worker_max_tasks_per_child = 50  # 单个worker处理的最大任务数
